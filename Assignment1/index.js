...
let concatenatedString = "The concatenated string is" + nullvariable +" "+ numbervariable +" "+ stringvariable +" "+ stringvariable +" "+ booleanvariable +" "+ bigintvariable +" "+ undefinedvariable +" "+ objectvariable +" "+ arrayvariable 
